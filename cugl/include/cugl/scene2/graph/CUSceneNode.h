...
#pragma mark Position
    ...
    /**
     * Returns the position of the anchor point node in screen space.
     *
     * Note that this is the position of the anchor point.  This is not the
     * same as the location of the node origin in world space.
     *
     * @return the position of the anchor point node in screen space.
     */
...
#pragma mark Size
    ...
    /**
     * Returns true if point is in the bounds of this node and its ancestors.
     *
     * This method checks if the point is in the content bounds of this node.
     * In addition, it will recursively check whether it is in the bound of
     * its ancestors. Only if the point is also in all of its ancestor's content
     * bounds will this method return true.
     *
     * @param point    The point to check against
     *
     * @return true if point is in the bounds of this node and its ancestors.
     */
    virtual bool inContentBounds(const Vec2 point);
   
    /**
     * Returns true if (x,y) is in the bounds of this node and its ancestors.
     *
     * This method checks if the point is in the content bounds of this node.
     * In addition, it will recursively check whether it is in the bound of
     * its ancestors. Only if the point is also in all of its ancestor's content
     ...
     *
     * @return true if (x,y) is in the bounds of this node and its ancestors.
     */
    bool inContentBounds(float x, float y) {
        return inContentBounds(Vec2(x,y));
    }
